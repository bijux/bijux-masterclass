...
Deep Dive Make teaches GNU Make as a disciplined dependency-graph engine rather
than as an ad hoc scripting surface.
...
- An executable capstone in `make-capstone/`
