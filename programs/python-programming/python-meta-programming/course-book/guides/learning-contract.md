...
1. Read the course in order from [Module 00](../module-00-orientation/index.md) to [Module 10](../module-10-runtime-governance-mastery-review/index.md), then close with [Mastery Review](../module-10-runtime-governance-mastery-review/mastery-review.md).
