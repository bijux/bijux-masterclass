...
This glossary belongs to **Module 10: Runtime Governance and Mastery Review** in **Python Metaprogramming**. It keeps the language of this directory stable so the same ideas keep the same names across reading, practice, review, and capstone proof.
...
| --- | --- |
| Module 10 Review: Mastery Review | the review surface that pressure-tests the module after the first read so the learner can check judgment, not just recall. |
