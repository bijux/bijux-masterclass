...
```mermaid
flowchart LR
  design["Choose inheritance at all"] --> mro["Understand the method resolution order"]
  mro --> super["Use cooperative super correctly"]
  super --> mixins["Keep mixins narrow and behavior-specific"]
```
<!-- page-maps:end -->
