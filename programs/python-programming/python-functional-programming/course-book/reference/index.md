...
graph LR
  ...
  standards["FP standards"]
  checklist["Review checklist"]
  prompts["Self-review prompts"]
...
```mermaid
flowchart LR
  need["Need a stable definition or review aid"] --> choose["Choose the narrowest reference page"]
  choose --> glossary["Glossary"]
  choose --> standards["Standards"]
  choose --> checklist["Checklist"]
  choose --> prompts["Prompts"]
```
<!-- page-maps:end -->
