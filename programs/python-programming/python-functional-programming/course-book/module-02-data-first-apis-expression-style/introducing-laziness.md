...
From `capstone/src/funcpipe_rag/rag_types.py` and `capstone/src/funcpipe_rag/api/types.py` (as in Core 1/2).
...
**Continue with:** [FP-Friendly APIs](../module-02-data-first-apis-expression-style/fp-friendly-apis.md)
