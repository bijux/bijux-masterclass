...
flowchart TD
  ...
  module --> concept["Async Pipeline Laws"]
...
No new runtime code. Laws are satisfied by design using existing combinators. Tests use these helpers (in `capstone/tests/helpers.py`):
