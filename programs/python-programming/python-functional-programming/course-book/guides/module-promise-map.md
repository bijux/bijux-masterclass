...
| `10` Refactoring, Performance, and Sustainment | You can govern and evolve the system without turning the design into theater. | You can justify a refactor, a performance change, or a proof route with evidence. | `module-10-refactoring-performance-sustainment/index.md`, `course-book/capstone/capstone-proof-guide.md`, `course-book/capstone/capstone-walkthrough.md` |
