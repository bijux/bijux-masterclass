...
| `10` Refactoring, Performance, and Sustainment | You can govern and evolve the system without turning the design into theater. | You can justify a refactor, a performance change, or a proof route with evidence. | `module-10-refactoring-performance-sustainment/index.md`, `capstone/PROOF_GUIDE.md`, `capstone/TOUR.md` |
