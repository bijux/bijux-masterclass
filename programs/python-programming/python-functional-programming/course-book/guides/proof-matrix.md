...
| Modules 09 to 10 | how interop, review, and sustainment stay honest | `tests/unit/interop/`, `capstone/TOUR.md`, `capstone/ARCHITECTURE.md`, `course-book/capstone/capstone-review-worksheet.md` |
