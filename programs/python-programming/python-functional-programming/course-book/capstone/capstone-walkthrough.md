...
1. Read the capstone's local [`WALKTHROUGH_GUIDE.md`](https://github.com/bijux/bijux-masterclass/blob/master/programs/python-programming/python-functional-programming/capstone/docs/WALKTHROUGH_GUIDE.md).
...
4. Read `capstone/docs/TOUR.md` for the purpose of the generated bundle.
