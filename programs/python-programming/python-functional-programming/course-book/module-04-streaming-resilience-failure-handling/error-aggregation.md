...
Refactor note: Result folds live in `funcpipe_rag.result.folds` (`capstone/src/funcpipe_rag/result/folds.py`) and are re-exported from
...
## 5. Property-Based Proofs (`capstone/tests/test_result_folds.py`)
...
**Continue with:** [Circuit Breakers](../module-04-streaming-resilience-failure-handling/circuit-breakers.md)
