...
flowchart TD
  ...
  module --> concept["Composing Effects"]
...
## 3. Public API – Composition Helpers (`capstone/src/funcpipe_rag/domain/composition.py`)

```python
# capstone/src/funcpipe_rag/domain/composition.py – mypy --strict clean
...
# - capstone/tests/unit/domain/test_io_plan_laws.py
#
# The `logged_read` helper is a thin wrapper in:
# - capstone/src/funcpipe_rag/domain/composition.py
#
...
**Continue with:** [Idempotent Effects](../module-07-effect-boundaries-resource-safety/idempotent-effects.md)
