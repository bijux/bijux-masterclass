...
flowchart TD
  ...
  module --> concept["Sessions and Transactions"]
...
Tests for this contract live in `capstone/tests/unit/domain/test_session.py`.
...
```python
# capstone/tests/test_session_tx.py – assumes imports/fixtures from core library
...
**Continue with:** [Incremental Migration](../module-07-effect-boundaries-resource-safety/incremental-migration.md)
