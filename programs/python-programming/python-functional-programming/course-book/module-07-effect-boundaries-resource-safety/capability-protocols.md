...
flowchart TD
  ...
  module --> concept["Capability Protocols"]
...
```python
# capstone/src/funcpipe_rag/infra/adapters/clock.py
...
```python
# Repo references:
# - Clocks: `capstone/src/funcpipe_rag/infra/adapters/clock.py`
# - File storage: `capstone/src/funcpipe_rag/infra/adapters/file_storage.py`
# - In-memory storage: `capstone/src/funcpipe_rag/infra/adapters/memory_storage.py`
#
# This repo currently tests file-storage resource safety and parse errors in:
# - capstone/tests/unit/infra/adapters/test_file_storage.py
```
...
**Continue with:** [Resource Safety](../module-07-effect-boundaries-resource-safety/resource-safety.md)
