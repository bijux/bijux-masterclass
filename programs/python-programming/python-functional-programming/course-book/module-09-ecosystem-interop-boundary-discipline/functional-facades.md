...
flowchart TD
  ...
  module --> concept["Functional Facades"]
...
---
## 3. Public API (`capstone/src/funcpipe_rag/domain/facades.py` – Pure Ports)
...
Runnable tests live in `capstone/tests/unit/domain/test_facades.py`.
```python
...
```
**Continue with:** [Cross-Process Composition](../module-09-ecosystem-interop-boundary-discipline/cross-process-composition.md)
