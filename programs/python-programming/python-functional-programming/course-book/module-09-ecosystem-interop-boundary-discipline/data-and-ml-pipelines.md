...
flowchart TD
  ...
  module --> concept["Data and ML Pipelines"]
...
Repo implementation lives in `capstone/src/funcpipe_rag/pipelines/configured.py` (stdlib-only, iterator-first, Result at the boundary).
...
Runnable tests live in `capstone/tests/unit/pipelines/test_configured_pipeline.py`.
```python
...
**Continue with:** [CLI and Config Pipelines](../module-09-ecosystem-interop-boundary-discipline/cli-and-config-pipelines.md)
