...
flowchart TD
  ...
  module --> concept["Web and Services"]
...
- A minimal guarded adapter exists at `capstone/src/funcpipe_rag/boundaries/web/fastapi_app.py` (`create_app()` raises ImportError if FastAPI isn't installed).
...
**Continue with:** [Data and ML Pipelines](../module-09-ecosystem-interop-boundary-discipline/data-and-ml-pipelines.md)
