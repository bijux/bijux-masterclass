...
flowchart TD
  ...
  module --> concept["Cross-Process Composition"]
...
---
## 3. Public API (`capstone/src/funcpipe_rag/pipelines/specs.py` – Serializable Specs)
**Repo alignment note (end-of-Module-09):**
- This repo uses **frozen dataclasses** (stdlib) for specs to keep dependencies light.
- Canonical hashing + allow-listed reconstruction are implemented in `capstone/src/funcpipe_rag/pipelines/specs.py`.
...
Runnable properties live in `capstone/tests/unit/pipelines/test_specs_roundtrip.py`.
```python
...
```
**Continue with:** [Team Adoption](../module-09-ecosystem-interop-boundary-discipline/team-adoption.md)
