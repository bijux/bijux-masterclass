...
flowchart TD
  ...
  module --> concept["Helper Libraries"]
...
- Runnable compat lives in:
  - `capstone/src/funcpipe_rag/interop/toolz_compat.py`
  - `capstone/src/funcpipe_rag/interop/returns_compat.py`
...
Runnable properties live in `capstone/tests/unit/interop/test_toolz_compat.py`.
```python
...
**Continue with:** [Data Processing](../module-09-ecosystem-interop-boundary-discipline/data-processing.md)
