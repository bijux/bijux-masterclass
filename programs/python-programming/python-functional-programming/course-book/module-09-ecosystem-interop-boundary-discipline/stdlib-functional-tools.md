...
flowchart TD
  ...
  module --> concept["Standard Library Functional Tools"]
...
- For runnable examples, see `capstone/src/funcpipe_rag/rag/stdlib_fp.py` and `capstone/src/funcpipe_rag/interop/stdlib_fp.py`.
...
Runnable properties live in `capstone/tests/unit/interop/test_stdlib_fp.py` and `capstone/tests/unit/rag/test_stdlib_fp.py`.
```python
...
**Continue with:** [Helper Libraries](../module-09-ecosystem-interop-boundary-discipline/helper-libraries.md)
