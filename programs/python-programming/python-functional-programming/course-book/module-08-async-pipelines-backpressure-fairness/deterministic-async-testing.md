...
flowchart TD
  ...
  module --> concept["Deterministic Async Testing"]
...
## 3. Public API – Deterministic Testing (`capstone/src/funcpipe_rag/domain/effects/async_/resilience.py` – mypy --strict clean)
...
**Continue with:** [Rate Limiting and Fairness](../module-08-async-pipelines-backpressure-fairness/rate-limiting-and-fairness.md)
