...
| --- | --- | --- |
| What does this repository prove for the course? | [`INDEX.md`](docs/index.md) | [`PROOF_GUIDE.md`](docs/proof-guide.md) |
| Which files should I read first? | [`INDEX.md`](docs/index.md) | [`PACKAGE_GUIDE.md`](docs/package-guide.md) |
| Which commands should I run? | [`COMMAND_GUIDE.md`](docs/command-guide.md) | `make inspect`, `make verify-report`, or `make confirm` |
| Which tests or artifacts justify a claim? | [`TEST_GUIDE.md`](docs/test-guide.md) | [`PROOF_GUIDE.md`](docs/proof-guide.md) |
| Where do purity, effects, and adapters live? | [`ARCHITECTURE.md`](docs/architecture.md) | [`PUBLIC_SURFACE_MAP.md`](docs/public-surface-map.md) |
| How should I review the repository as a human? | [`WALKTHROUGH_GUIDE.md`](docs/walkthrough-guide.md) | [`TOUR.md`](docs/tour.md) |
...
2. Open [`TEST_GUIDE.md`](docs/test-guide.md) or [`PACKAGE_GUIDE.md`](docs/package-guide.md), depending on whether you want proof-first or code-first reading.
...
- [`PUBLIC_SURFACE_MAP.md`](docs/public-surface-map.md)
