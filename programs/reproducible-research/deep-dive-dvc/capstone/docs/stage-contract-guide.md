...
- read [RECOVERY_GUIDE.md](recovery-guide.md) when the next question is which state is authoritative after local loss and restore
- read [PUBLISH_CONTRACT.md](publish-contract.md) when the question moves from stage truth to downstream trust
