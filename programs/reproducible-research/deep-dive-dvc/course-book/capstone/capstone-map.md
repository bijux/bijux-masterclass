...
| 07 Collaboration and CI | which checks another maintainer can run without oral context | `Makefile`, `tests/`, [Verification Route Guide](../reference/verification-route-guide.md) | `make verify` |
