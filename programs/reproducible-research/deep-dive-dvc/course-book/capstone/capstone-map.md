...
| --- | --- | --- | --- |
| 01 Reproducibility Failures | why rerunnable scripts are weaker than explicit state contracts | `README.md`, `data/raw/`, `docs/DOMAIN_GUIDE.md` | `make walkthrough` |
...
| 07 Collaboration and CI | which checks another maintainer can run without oral context | `Makefile`, `tests/`, `docs/REVIEW_ROUTE_GUIDE.md` | `make verify` |
