...
3. read [TARGET_GUIDE.md](target-guide.md) to learn the public target surface
4. read [PROOF_GUIDE.md](proof-guide.md) to see how claims map to evidence
