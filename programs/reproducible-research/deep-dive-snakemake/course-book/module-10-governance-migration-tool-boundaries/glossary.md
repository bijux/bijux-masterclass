...
This glossary belongs to **Module 10: Governance, Migration, and Tool Boundaries** in **Deep Dive Snakemake**. It keeps the language of this directory stable so the same ideas keep the same names across reading, practice, review, and capstone proof.
