...
This glossary belongs to **Module 08: Operating Contexts and Execution Policy** in **Deep Dive Snakemake**. It keeps the language of this directory stable so the same ideas keep the same names across reading, practice, review, and capstone proof.
