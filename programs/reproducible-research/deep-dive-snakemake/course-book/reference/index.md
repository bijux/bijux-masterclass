...
```mermaid
flowchart LR
  question["Choose the stable reference question"] --> vocab["Vocabulary and concepts"]
  question --> route["Study and proof routing"]
  question --> review["Boundary and repository review"]
  question --> assess["Completion and readiness"]
```
<!-- page-maps:end -->
