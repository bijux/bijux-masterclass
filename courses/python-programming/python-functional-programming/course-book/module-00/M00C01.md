...
2. Install the capstone tooling from the repository root: `make COURSE=python-programming/python-functional-programming install`.
3. Run the doc server from the repository root: `make COURSE=python-programming/python-functional-programming docs-serve`.
4. Run tests to ensure baseline correctness: `make COURSE=python-programming/python-functional-programming test`.
